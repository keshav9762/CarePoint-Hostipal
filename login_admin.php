...
<div class="form-container login-container">
  <div class="login-icon-wrapper">
    <div class="login-icon-circle" style="background: #4facfe;">
      <i class="fas fa-user-shield"></i>
    </div>
    <div class="login-badge" style="background: #4facfe;">ADMIN LOGIN</div>
  </div>
  ...
  <form class="login-form" action="login_admin.php" method="post">
    ...
    <button type="submit" class="login-submit-btn" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); box-shadow: 0 4px 15px rgba(79, 172, 254, 0.3);">
  ...
  <div style="text-align: center; margin-top: 20px;">
    <a href="index.html" class="back-home-btn" style="border-color: #4facfe; color: #4facfe;">
